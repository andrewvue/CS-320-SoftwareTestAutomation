...
public class TaskServiceTest {
   ...
   @Test public void invalidID() {      
      Task task = new Task("0000000002x", "Playing", "Playing rock paper scissors");
      addTask(task);
      System.out.println("size: " + tasks.size());
   }
   
   @Test public void invalidName() {      
      Task task = new Task("0000000002", "Playing Playing Playing Playing Playing Playing Playing", "Playing rock paper scissors");
      addTask(task);
      System.out.println("size: " + tasks.size());
   }
   
   @Test public void invalidDescription() {      
      Task task = new Task("0000000002", "Playing", "Playing rock paper scissors Playing rock paper scissors Playing rock paper scissors Playing rock paper scissors Playing rock paper scissors Playing rock paper scissors");
      addTask(task);
      System.out.println("size: " + tasks.size());
   }
   ...
   @Test public void updateTask() {      
      Task task = new Task("0000000001", "Singing", "Don't stop believing");
      update(task);
